######  Modified_ComBat   ####################################################################################
## 
##   Overview:  Run M_ComBat to harmonize radiomic feturtes data to
##              a pre-determined, 'gold-standard' samples.
##
##   Packages:  Load 'sva' and 'boot'package
##
##   Input:
...
M_ComBat <- function (dat, batch, center , mod, numCovs = NULL ) 
{
